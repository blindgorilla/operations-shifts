...
('new_employee_pairing', 'New Employee Pairing', 'On night shifts, a new employee must be paired with an experienced guard and never left alone or paired with another new employee.', 'warning', true, '{}'),
